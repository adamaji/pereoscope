...
BROADCAST_ID_ONE = "1mnGeYODEZQGX"
BROADCAST_ID_TWO = ""
SCALE = 500.0
...
if __name__ == "__main__":
    ...
    hls_url1 = utils.get_stream_url(BROADCAST_ID_ONE) # Me
    hls_url2 = utils.get_stream_url(BROADCAST_ID_ONE) # Adam
